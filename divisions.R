...
# Directory holding region_division_lookup.csv. Matches the convention used by
# the other scripts; override with the CFOS_DATA_DIR environment variable.
.DIV_DIR <- Sys.getenv("CFOS_DATA_DIR", "data")
